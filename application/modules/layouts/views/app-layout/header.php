        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index-2.html">
              ...
              <h2 class="brand-text">Cityook</h2>
            </a>
          </li>
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="assets/images/slider/slider-2.png"
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="user-profile.html"><i class="ft-user"></i>Profile</a>
                ...
                <a class="dropdown-item" href="<?php echo base_url();?>auth/login"><i class="ft-power"></i> Login</a>
