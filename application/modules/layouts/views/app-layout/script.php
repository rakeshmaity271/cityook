...
<script src="<?php echo base_url('assets/vendors/js/forms/select/select2.full.min.js');?>" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url('assets/vendors/js/extensions/jquery.knob.min.js');?>" type="text/javascript"></script>

  <script src="<?php echo base_url('assets/js/scripts/extensions/knob.min.js');?>" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url('assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js');?>"

  type="text/javascript"></script>

  <script src="<?php echo base_url('assets/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js');?>"

  type="text/javascript"></script>

  <script src="<?php echo base_url('assets/data/jvector/visitor-data.js');?>" type="text/javascript"></script>

  <script src="<?php echo base_url('assets/vendors/js/charts/chart.min.js');?>" type="text/javascript"></script>

  <script src="<?php echo base_url('assets/vendors/js/charts/jquery.sparkline.min.js');?>" type="text/javascript"></script>
  ...
  <script src="<?php echo base_url('assets/js/scripts/pages/dashboard-analytics.min.js');?>" type="text/javascript"></script>
...
<script src="<?php echo base_url('assets/vendors/js/forms/validation/jqBootstrapValidation.js');?>"  type="text/javascript"></script>
   ...
   <script src="<?php echo base_url('assets/js/scripts/forms/validation/form-validation.js');?>" type="text/javascript"></script>

  <script src="<?php echo base_url('assets/vendors/js/forms/toggle/bootstrap-checkbox.min.js');?>"  type="text/javascript"></script>
