			...
			<div class="navbar-collapse collapse navbar-warning-collapse">
				...
				<!--<li><a href="<?php echo base_url();?>" class="material_navbar_nav_item" >
					...
					<li class="dropdown">
						...
						<a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="cursor: hand; cursor: pointer;"><span class="hidden-xs hidden-sm hideName">  &nbsp; <span itemprop="areaServed">Areas Served</span></span> <span class="caret"></span></a>

						<ul class="dropdown-menu material_dropdown_menu" role="menu">

							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Mumbai' data-cityID='1'>Danapur</a></li>

							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Pune' data-cityID='2'>Khagaul Road</a></li>

							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Bangalore' data-cityID='3'>Saguna More</a></li>

							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Hyderabad' data-cityID='5'>Rps Road</a></li>

							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Gurgaon' data-cityID='6'>Dps Road</a></li>

							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Delhi' data-cityID='8'>Ias Colony</a></li>

							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Chennai' data-cityID='11'>Rukan Pura</a></li>
							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Chennai' data-cityID='11'>Jagdeo Path</a></li>
							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Chennai' data-cityID='11'>Gola Road</a></li>
							<li><a href='#' class='material_dropdown_menu_link citySelectionTopMenu' data-cityName='Chennai' data-cityID='11'>Ashiana Nagar</a></li>
