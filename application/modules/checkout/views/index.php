...
<input name="identity" class="form-control" id="bfullname" placeholder="Enter Full Name" type="text" required="">
 <span class="material-input"></span>
				</div>
				
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">Email</label>
<input name="identity" class="form-control" id="bemail" placeholder="Enter Email No" type="text" required="">
 <span class="material-input"></span>
				</div>
				<div class="form-group">
...
<input name="identity" class="form-control" placeholder="Enter Mobile No" type="text" required="">
 <span class="material-input"></span>
				...
				<textarea  name="identity" class="form-control" placeholder="Enter Address" required=""></textarea>

 <span class="material-input"></span>
				</div>
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">City</label>
<input name="identity" class="form-control" placeholder="Enter City" type="text" required="">
 <span class="material-input"></span>
				</div>
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">Pincode</label>
<input name="identity" class="form-control" placeholder="Enter Pincode" type="text" required="">
 <span class="material-input"></span>
				</div>
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">State</label>
<input name="identity" class="form-control" placeholder="Enter State" type="text" required="">
 <span class="material-input"></span>
				</div>
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">Country</label>
<input name="identity" class="form-control" placeholder="Enter State" type="text" value="India" required="" readonly>
 <span class="material-input"></span>
				</div>
		...
		<div class="col-md-6">
			...
			<div class="woocommerce-shipping-fields">
				<h3 id="ship-to-different-address">
					...
					<input type="checkbox" value="1" name="ship_to_different_address" class="input-checkbox" id="ship-to-different-address-checkbox" onclick="SameShippingaddress(this.checked);">
				</h3>
			<div class="row">
				<div class="col-lg-10">
				...
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">Full Name</label>
<input name="identity" class="form-control" id="sfullname" placeholder="Enter Full Name" type="text" required="">
 <span class="material-input"></span>
				</div>
				
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">Email</label>
<input name="identity" class="form-control" id="semail" placeholder="Enter Email No" type="text" required="">
 <span class="material-input"></span>
				</div>
				<div class="form-group">
				<label for="name" class="cols-sm-2 control-label">Mobile</label>
...
<input name="identity" class="form-control" placeholder="Enter State" type="text" value="India" required="" readonly>
 <span class="material-input"></span>
	...
	<div class="row">
	<h3 id="order_review_heading" style="text-align:center;">Your Order Preview</h3>
		...
		<div class="woocommerce-checkout-payment" id="payment">
			<ul class="wc_payment_methods payment_methods methods">
				...
				<li class="wc_payment_method payment_method_paypal">
					...
					<label for="payment_method_paypal">PayPal <a title="What is PayPal?" onclick="javascript:window.open('https://www.paypal.com/us/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;" class="about_paypal" href="https://www.paypal.com/us/webapps/mpp/paypal-popup">What is PayPal?</a></label>
			...
			<div class="form-row place-order">
				...
				<input type="submit" data-value="Place order" value="Place order" class="btn btn-primary button alt">
			</div>
		</div>
	</div>
	</div>
...
<?php echo $script;?>
  ...
  function SameShippingaddress(checked) 
{ 
	if (checked) 
	{  
		document.getElementById('sfullname').value = document.getElementById('bfullname').value;   
