      ...
      <div class="row">
         <section class="col-main col-sm-12">
            <div id="contact" class="page-content page-contact">
               ...
               <div class="text-left">
                  <div class="col-md-12">
                     <h2 style="text-align:center;"> Preview Order<!--<span id="cart-items-count">
                        </span>-->
                     </h2>
                     <!-- Start Checkout page-->
                     <?php if($isPayumoney) { ?>
                        <form action="<?php echo $hiddenFields['action'] ?>" method="post" id="payu_form" name="payu_form" class="checkout woocommerce-checkout">
                        <?php if(count($hiddenFields) > 0 ) { ?>
        ...
        <div id="customer_details" class="col2-set">
            <div class="col-md-6">
                <div class="woocommerce-billing-fields">
                    ...
                    <h2>&nbsp;</h2>
                    <ul>
                        <li><strong>Full Name:</strong>&nbsp;<?php echo $billingAddress['fullname'];?></li>
                        <li><strong>Mobile:</strong>&nbsp;<?php echo $billingAddress['mobile'];?></li>
                        <li><strong>Email-Id:</strong>&nbsp;<?php echo $billingAddress['email'];?></li>
                        <li><strong>Address:</strong>&nbsp;<?php echo $billingAddress['address'];?>,&nbsp;<?php echo $billingAddress['pincode'];?>,&nbsp;<?php echo $billingAddress['state'];?>,&nbsp;<?php echo $billingAddress['country'];?></li>
                        
                        <!-- <li><strong>Pincode:</strong>&nbsp;<?php echo $shippingAddress['pincode'];?></li>
                        <li><strong>State:</strong>&nbsp;<?php echo $shippingAddress['state'];?></li>
                        <li><strong>Country:</strong>&nbsp;<?php echo $shippingAddress['country'];?></li> -->
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
                <div class="woocommerce-billing-fields">
                    ...
                    <!-- <input type="hidden" value="" name="shippingAddress['pincode']">  -->
                        ...
                        <li><strong>Address:</strong>&nbsp;<?php echo $shippingAddress['address'];?>,&nbsp;<?php echo $shippingAddress['pincode'];?>,&nbsp;<?php echo $shippingAddress['state'];?>,&nbsp;<?php echo $shippingAddress['country'];?></li>
