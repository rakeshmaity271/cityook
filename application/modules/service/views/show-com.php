    ...
    <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
        ...
        <div class="btn-group" role="group">
            <button type="button" id="favorites" class="btn btn-default" href="#tab2" data-toggle="tab"><!--<span class="glyphicon glyphicon-heart" aria-hidden="true"></span>-->
                <div class="hidden-xs"> Installation/Removal</div>
            </button>
        </div>
        <div class="btn-group" role="group">
        ...
        <div class="tab-pane fade in active" id="tab1">
          	<!-- service description start here --->
				<div class="row" style="padding:0px 20px;">
				    <div class="col-lg-6">
				        <h2 style="padding:10px 30px;">Service Content:-</h2>
				        <ul style="list-style-type:square">
				            <li class="webaboutp">Diagnosis of the problem</li>
				            <li class="webaboutp">Diagnosis of the problem</li>
				            <li class="webaboutp">Diagnosis of the problem</li>
				            <li class="webaboutp">Diagnosis of the problem</li>
				        </ul>
				     ...
				     <div class="col-lg-6" style="padding:30px 10px;">
				         
				         <p style="font-size:20px;"><strong>Inspection Time:</strong> 30 mins / AC</p>
				         <p>&nbsp;</p>
				         <p style="font-size:20px;"><strong>No. of Servicemen:</strong> 1-2</p>
				     </div>
				     <div class="col-lg-12">
				         
				         <h2 style="padding:10px 30px;">Note:-</h2>
				        <ul style="list-style-type:disc">
				            <li class="webaboutp">Parts replacement, material cost, transportation cost (if applicable) would be on actual and are to be settled with the service partner</li>
				            <li class="webaboutp">Parts replacement, material cost, transportation cost (if applicable) would be on actual and are to be settled with the service partner</li>
				            <li class="webaboutp">Parts replacement,  material cost, transportation cost (if applicable) would be on actual and are to be settled with the service partner</li>
				            <li class="webaboutp">Parts replacement,  material cost, transportation cost (if applicable) would be on actual and are to be settled with the service partner</li>
				        </ul>
