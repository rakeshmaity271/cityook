                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              ...
                              <div class="custom-file">
                                <input type="file" class="custom-file-input" id="inputGroupFile01" data-validation-required-message="This field is required">
                          ...
                          <div class="form-group">
                            ...
                            <div class="controls">
                              ...
                              <select class="select2-language form-control" id="select2-language" data-validation-required-message="This field is required" >
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="controls">
                            <textarea class="form-control" id="descTextarea" rows="3" placeholder="Description"></textarea>
                            <div class="help-block"></div></div>
