...
$config['employee_group']             = 'employee';         // Default administrators group, use name
$config['customer_group']             = 'customer';
$config['identity']                   = 'mobile';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
